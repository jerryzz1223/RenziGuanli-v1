		...
		workspace.innerHTML = `
			...
			<div class="hrms-training-import-center">
				<div class="hrms-training-import-center-copy">
					...
					<span>${__("以年度计划总表和教育训练登记表为准，先解析校验，再用当前公司的公司工号匹配员工。")}</span>
				</div>
