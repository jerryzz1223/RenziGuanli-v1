...
def get_custom_fields():
	...
	return {
		...
		"Department": [
			...
			{
				"fieldname": "hrms_org_section",
				"fieldtype": "Section Break",
				"label": _("Organization Management"),
			...
			},
			{
				...
				"insert_after": "hrms_org_section",
			},
			{
				"fieldname": "hrms_org_role",
				"fieldtype": "Data",
				"label": _("Organization Role"),
				"insert_after": "hrms_org_level",
			},
			{
				"fieldname": "hrms_org_manager",
				"fieldtype": "Data",
				"label": _("Organization Manager"),
				"insert_after": "hrms_org_role",
			},
			{
				"fieldname": "hrms_org_proxy",
				"fieldtype": "Data",
				"label": _("Proxy Manager"),
			...
			},
			{
				...
				"fieldtype": "Int",
				"label": _("Planned Headcount"),
				"insert_after": "hrms_org_column_break",
			},
			{
				"fieldname": "hrms_actual_headcount",
				"fieldtype": "Int",
				"label": _("Actual Headcount"),
				"insert_after": "hrms_planned_headcount",
			},
			{
				"fieldname": "hrms_vacancy_count",
				"fieldtype": "Int",
				"label": _("Vacancy Count"),
				"insert_after": "hrms_actual_headcount",
			},
			{
				"fieldname": "hrms_recruitment_plan",
				"fieldtype": "Small Text",
				"label": _("Recruitment Plan"),
				"insert_after": "hrms_vacancy_count",
			},
			{
				"fieldname": "hrms_org_source_cell",
				"fieldtype": "Data",
				"label": _("Organization Source Cell"),
				"read_only": 1,
		...
		"Designation": [
			...
			},
			{
				"fieldname": "hrms_org_section",
				"fieldtype": "Section Break",
				"label": _("Organization Hierarchy"),
				"insert_after": "skills",
			},
			{
				"fieldname": "hrms_parent_designation",
				"fieldtype": "Link",
				"label": _("Parent Designation"),
				"options": "Designation",
				"insert_after": "hrms_org_section",
			},
			{
				"fieldname": "hrms_source_department",
				"fieldtype": "Link",
				"label": _("Source Department"),
				"options": "Department",
				"insert_after": "hrms_parent_designation",
			},
			{
				"fieldname": "hrms_org_source_cell",
				"fieldtype": "Data",
				"label": _("Organization Source Cell"),
				"read_only": 1,
				"insert_after": "hrms_source_department",
			},
		],
		"Employee": [
			{
