...
FIELD_DEFINITIONS = [
	...
	{"fieldname": "deep_night_shift_count", "label": "深夜班次数", "group": "考勤字段", "source": "锁定考勤明细按深夜班时段匹配"},
	...
	{"fieldname": "housing_subsidy", "label": "住房补贴", "group": "考勤字段", "source": "已锁定考勤终稿（考勤补充来源）"},
...
FORMULA_TEMPLATES = [
	...
	{"output_field": "night_shift_allowance", "expression": "[深夜班次数] * 55 + [大夜班次数] * 45 + [小夜班次数] * 24", "category": "考勤结算", "description": "夜班津贴按深夜班、大夜班、小夜班三档计算"},
