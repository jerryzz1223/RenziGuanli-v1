...
for (const marker of [
	...
	"exception_query_request_id",
	"exception_query_snapshot",
	"snapshot_record_ids",
	"reuseSnapshot: true",
	"requestId !== this.exception_query_request_id || this.active_view !== \"exceptions\"",
	"ledger_query_request_id",
	...
	"data-import-shift-rules",
	"data-edit-shift-rule",
	"排班规则导入预览",
