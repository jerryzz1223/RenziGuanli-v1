...
for (const marker of [
	...
	"data-open-source-card", "打开{0}明细", "待确认 / 有异常可修改", "allow_multiple: false", "data-source-card-preview", "data-source-card-records", "data-source-card-editable", "data-finish-source-edit", "修改后自动保存", "data-inline-variable-record", "queue_inline_variable_save", "data-edit-variable-record", "data-confirm-source-card", "data-upload-source-version", "data-create-editable-source-card", "确认入账", "已确认入账", "当前数据已确认入账", "未匹配原因", "不参与计算", "本月数据明细", "暂无本月明细", "hrms-payroll-variable-source-state", "data-table-sort", "data-table-column-search", "prioritize_table_rows", "orderedRows",
